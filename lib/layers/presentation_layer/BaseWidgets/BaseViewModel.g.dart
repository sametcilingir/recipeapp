...
mixin _$BaseViewModel on _BaseViewModelBase, Store {
  late final _$onInitAsyncAction =
      AsyncAction('_BaseViewModelBase.onInit', context: context);
  ...
  late final _$onViewModelReadyAsyncAction =
      AsyncAction('_BaseViewModelBase.onViewModelReady', context: context);
  ...
  late final _$onDisposeAsyncAction =
      AsyncAction('_BaseViewModelBase.onDispose', context: context);
